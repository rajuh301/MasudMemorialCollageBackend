...
router.patch("/:id", (0, auth_1.default)(client_1.UserRole.SUPER_ADMIN, client_1.UserRole.ADMIN), fileUploader_1.fileUploader.upload.single("file"), // Handle file in update
(req, res, next) => {
    if (req.body.data) {
        req.body = event_validation_1.EventValidation.updateEventValidation.parse(JSON.parse(req.body.data));
    }
