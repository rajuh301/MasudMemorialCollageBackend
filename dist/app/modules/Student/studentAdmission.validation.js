...
exports.createStudentAdmissionValidation = zod_1.z.object({
    ...
    dateOfBirth: zod_1.z.string({ required_error: "Date of birth is required" }), // manual input
    ...
    previousGPA: zod_1.z.number().optional(),
    passingYear: zod_1.z.number().optional(),
    ...
    image: zod_1.z.string().optional() // like SubBanner
});
