...
router.get('/total-user', user_controller_1.userController.getTotalUser);
router.get('/me', (0, auth_1.default)(client_1.UserRole.SUPER_ADMIN, client_1.UserRole.ADMIN, client_1.UserRole.TEACHER, client_1.UserRole.STUDENT, client_1.UserRole.OFFICESTAFF), user_controller_1.userController.getMyProfile);
...
router.post("/create-office-staff", (0, auth_1.default)(client_1.UserRole.SUPER_ADMIN, client_1.UserRole.ADMIN), fileUploader_1.fileUploader.upload.single('file'), (req, res, next) => {
    req.body = user_validation_1.userValidation.createOfficeStaff.parse(JSON.parse(req.body.data));
    return user_controller_1.userController.createOfficeStaff(req, res, next);
});
router.get("/get-staffs", (0, auth_1.default)(client_1.UserRole.SUPER_ADMIN, client_1.UserRole.ADMIN, client_1.UserRole.TEACHER, client_1.UserRole.STUDENT), user_controller_1.userController.getAllOfficeStaffs);
router.get("/get-all-teachers", (0, auth_1.default)(client_1.UserRole.SUPER_ADMIN, client_1.UserRole.ADMIN, client_1.UserRole.TEACHER, client_1.UserRole.STUDENT), user_controller_1.userController.getAllTeachers);
router.get("/get-all-students", user_controller_1.userController.getAllStudents);
